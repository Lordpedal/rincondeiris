...
function lunr_search(term) {
    ...
    if(term) {
        document.getElementById('lunrsearchresults').innerHTML = "<p>Resultados de busqueda para '" + term + "'</p>" + document.getElementById('lunrsearchresults').innerHTML;
...
function lunr_search(term) {
    ...
    if(term) {
        ...
        if(results.length>0){
            ...
            document.querySelectorAll('#lunrsearchresults ul')[0].innerHTML = "<li class='lunrsearchresult'>Lo siento, no se han encontrado coincidencias para tu busqueda!</li>";
        }
    }
    return false;
}
